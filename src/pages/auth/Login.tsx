...
export default function Login() {
  return (
    <div className="auth-container">
        <AuthHeader imageSrc={loginImage} headingText="Hey There! Let's Get You Logged In." />
        <div className='auth-form-container'>
          <form className='login-form' action="/login" method="POST">
            ...
            <div className='auth-form-forgot-anchor-container'>
              <a href='#'>Lost Your Key?<span> Let's Find It Together!</span></a>
            </div>
            <div className='auth-form-button-div'>
              <Button text="Login & Begin Your Journey" color="#4535EA" padding="12px 16px" width="100%"/>
            </div>
          </form>
        </div>
    </div>

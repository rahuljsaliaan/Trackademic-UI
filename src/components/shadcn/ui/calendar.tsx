    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          'h-7 w-7 bg-transparent p-0 opacity-50 hover:bg-transparent'
        ),
        ...
        day_today: 'bg-transparent hover:bg-transparent',
        day_outside:
          'day-outside text-muted-foreground text-[16px] font-bold opacity-50 hover:bg-transparent',
        day_disabled:
          'text-muted-foreground text-[16px] font-bold opacity-50 hover:bg-transparent',
        day_range_middle:
          'aria-selected:bg-transparent text-[16px] font-bold hover:bg-transparent',
